...
const Header = () => {
  ...
  // ── NEW: fetch unread reply count for badge ───────────────
  useEffect(() => {
    const storedUser = localStorage.getItem("user");
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div ref={searchRef} className="hidden md:flex flex-1 max-w-xl mx-8 relative">
              <div className="relative w-full">
                <input
                  ...
                  className={`w-full px-4 py-2.5 pr-10 bg-gray-100 rounded-lg outline-none transition
                    ${searchFocus
                    ...
                    {filtered.map((s) => (
                      ...
                      >
                        ...
                        <span className={`text-xs px-2 py-0.5 rounded-full font-medium
                          flex-shrink-0 ${TAG_COLORS[s.tag]}`}>
                          {s.tag}
                        </span>
                      </button>
                    ))}
            ...
            <div className="flex items-center gap-4">
              ...
              {/* ASK — only this button changed, bell badge added */}
              <button
                onClick={() => {
                  setShowAsk(true);
                  setReplyCount(0); // clear badge when modal opens
                }}

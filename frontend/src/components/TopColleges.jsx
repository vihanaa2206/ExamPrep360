...
/* ── local image map — same as CollegeDetails ─────────────── */
            ...
            >
              ...
              <div className="w-40 flex-shrink-0 relative overflow-hidden">
                {img ? (
                  ...
                  /* Gradient fallback — NO blue placeholder box */
                  <div className="w-full h-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                    <span className="text-white text-4xl font-black opacity-60 select-none">
              ...
              <div className="flex-1 p-4 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="font-bold text-gray-900 group-hover:text-blue-600 transition-colors text-base mt-1 mb-0.5">
                    {college.short_name}
                  </h3>
